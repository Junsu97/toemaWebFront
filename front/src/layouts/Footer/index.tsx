...
export default function Footer() {
    ...
    const onInstaIconButtonClickHandler = () => {
        window.open('https://www.instagram.com/poly_kangseo/');
    };
    // event handler : 네이버 블로그 아이콘 버튼 클릭 이벤트 처리
    const onNaverBlogButtonClickHandler = () => {
        window.open('https://blog.naver.com/kangseokopo');
    }
      ...
      <div className='footer-container'>
        <div className='footer-top'>
            <div className='footer-logo-box'>
                ...
                <div className='footer-logo-text'>{'과외해듀오'}</div>
            </div>
            <div className='footer-link-box'>
                <div className='footer-email-link'>{'2320110214@office.kopo.ac.kr'}</div>
        ...
        <div className='footer-bottom'>
            <div className='footer-copyright'>{'Copyright ⓒ 2024 HanJunsu. All Rights Reserved.'}</div>
        </div>
      </div>
    </div>
  )
